...
export const CreateCourseLessonVideoJoi = Joi.object<CreateCourseLessonVideoDto>({
...
export const UpdateCourseLessonVideoJoi = Joi.object<UpdateCourseLessonVideoDto>({
  name: Joi.string(),
  description: Joi.string(),
