...
class PrismaCourseLessonRandDB extends RandDBUtil_1.default {
    constructor() {
        super(...arguments);
    ...
    generateOne(authorUserRole) {
        return __awaiter(this, void 0, void 0, function* () {
            const resources = yield this.course.generateOne(authorUserRole);
            const lesson = yield this.prisma.courseLesson.create({
                data: Object.assign(Object.assign({}, this.generateDto()), { courseId: resources.course.id }),
            });
            ...
            return Object.assign(Object.assign({}, resources), { lesson: (0, getValuable_1.default)(lesson) });
        });
    }
    generateDto() {
        return {
...
exports.default = PrismaCourseLessonRandDB;
__decorate([
    (0, inversify_1.inject)(rand_type_1.PrismaRandDBDITypes.COURSE),
    __metadata("design:type", Object)
], PrismaCourseLessonRandDB.prototype, "course", void 0);
