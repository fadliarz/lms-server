...
let DepartmentDivisionEnrollmentController = class DepartmentDivisionEnrollmentController {
    createEnrollment(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield (0, validateJoi_1.default)({ body: enrollment_joi_1.CreateDepartmentDivisionEnrollmentDtoJoi })(req, res, next);
    ...
    getEnrollments(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const enrollments = yield this.service.getEnrollments({
    ...
    validateResourceId(req) {
        ...
        if ((0, isNaNArray_1.default)([departmentId, divisionId])) {
...
__decorate([
    (0, inversify_1.inject)(enrollment_type_1.DepartmentDivisionEnrollmentDITypes.SERVICE),
    __metadata("design:type", Object)
], DepartmentDivisionEnrollmentController.prototype, "service", void 0);
DepartmentDivisionEnrollmentController = __decorate([
    (0, inversify_1.injectable)()
], DepartmentDivisionEnrollmentController);
exports.default = DepartmentDivisionEnrollmentController;
