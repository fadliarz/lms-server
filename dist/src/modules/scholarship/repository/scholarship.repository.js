...
let ScholarshipRepository = class ScholarshipRepository extends BaseRepository_1.default {
    constructor() {
        super();
    }
    ...
    getScholarshipByIdOrThrow(scholarshipId, error) {
        return __awaiter(this, void 0, void 0, function* () {
            const scholarship = yield this.db.scholarship.findUnique({
                where: {
                    id: scholarshipId,
                },
            });
...
ScholarshipRepository = __decorate([
    (0, inversify_1.injectable)(),
    __metadata("design:paramtypes", [])
], ScholarshipRepository);
exports.default = ScholarshipRepository;
