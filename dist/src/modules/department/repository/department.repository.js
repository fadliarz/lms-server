...
let DepartmentRepository = class DepartmentRepository extends BaseRepository_1.default {
    constructor() {
        super();
    }
    ...
    getDepartmentByIdOrThrow(departmentId, error) {
        return __awaiter(this, void 0, void 0, function* () {
            const department = yield this.getDepartmentById(departmentId);
            if (!department) {
