...
let PersonalAssignmentRepository = class PersonalAssignmentRepository extends BaseRepository_1.default {
    constructor() {
        super();
    }
    createAssignment(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.personalAssignment.create({
                data: Object.assign(Object.assign({}, data), { userId: id.userId }),
            });
        });
    }
    getAssignments(id) {
...
PersonalAssignmentRepository = __decorate([
    (0, inversify_1.injectable)(),
    __metadata("design:paramtypes", [])
], PersonalAssignmentRepository);
exports.default = PersonalAssignmentRepository;
