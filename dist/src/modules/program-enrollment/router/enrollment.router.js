...
function DepartmentProgramEnrollmentRouter(authenticationMiddleware) {
     ...
     *
     */
    router.post(enrollment_api_1.$DepartmentProgramEnrollmentAPI.CreateEnrollment.endpoint, authenticationMiddleware, controller.createEnrollment.bind(controller));
    /**
     * Delete
     *
     */
    router.delete(enrollment_api_1.$DepartmentProgramEnrollmentAPI.DeleteEnrollment.endpoint, authenticationMiddleware, controller.deleteEnrollment.bind(controller));
    return router;
}
