...
let DepartmentProgramEnrollmentRepository = class DepartmentProgramEnrollmentRepository extends BaseRepository_1.default {
    constructor() {
        super();
    }
    createEnrollment(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (id.resourceId) {
                const program = yield this.db.departmentProgram.findFirst({
                    where: {
                        id: id.programId,
            ...
            return this.db.departmentProgramEnrollment.create({
                data: Object.assign(Object.assign({}, data), { programId: id.programId }),
            });
        });
    }
...
DepartmentProgramEnrollmentRepository = __decorate([
    (0, inversify_1.injectable)(),
    __metadata("design:paramtypes", [])
], DepartmentProgramEnrollmentRepository);
exports.default = DepartmentProgramEnrollmentRepository;
