...
let DepartmentDivisionRepository = class DepartmentDivisionRepository extends BaseRepository_1.default {
    constructor() {
        super();
    }
    createDivision(data) {
    ...
    getDivisionByIdOrThrow(divisionId, error) {
        return __awaiter(this, void 0, void 0, function* () {
            const division = yield this.getDivisionById(divisionId);
            if (!division) {
...
DepartmentDivisionRepository = __decorate([
    (0, inversify_1.injectable)(),
    __metadata("design:paramtypes", [])
], DepartmentDivisionRepository);
exports.default = DepartmentDivisionRepository;
