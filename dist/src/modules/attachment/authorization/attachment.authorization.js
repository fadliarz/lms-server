...
let CourseLessonAttachmentAuthorization = class CourseLessonAttachmentAuthorization extends BaseAuthorization_1.default {
    authorizeCreateAttachment(user, courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.lessonAuthorization.authorizeUpdateLesson(user, courseId);
        });
    }
    authorizeReadAttachment(user, courseId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    authorizeUpdateAttachment(user, courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.lessonAuthorization.authorizeUpdateLesson(user, courseId);
        });
    }
    authorizeDeleteAttachment(user, courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.lessonAuthorization.authorizeUpdateLesson(user, courseId);
        });
    }
...
], CourseLessonAttachmentAuthorization.prototype, "lessonAuthorization", void 0);
CourseLessonAttachmentAuthorization = __decorate([
    (0, inversify_1.injectable)()
], CourseLessonAttachmentAuthorization);
exports.default = CourseLessonAttachmentAuthorization;
