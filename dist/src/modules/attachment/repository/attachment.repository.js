...
let CourseLessonAttachmentRepository = class CourseLessonAttachmentRepository extends BaseRepository_1.default {
    constructor() {
        super();
    }
    ...
    getAttachments(id, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.courseLessonAttachment.findMany(Object.assign({ where: this.getWhereObjectForFirstLevelOperation(id) }, (0, getQueryExtendObject_1.default)(query)));
        });
    }
    ...
    getAttachmentByIdOrThrow(id, error) {
        return __awaiter(this, void 0, void 0, function* () {
...
CourseLessonAttachmentRepository = __decorate([
    (0, inversify_1.injectable)(),
    __metadata("design:paramtypes", [])
], CourseLessonAttachmentRepository);
exports.default = CourseLessonAttachmentRepository;
