...
let DepartmentProgramAuthorization = class DepartmentProgramAuthorization extends BaseAuthorization_1.default {
    ...
    authorizeUpdateProgram(user, departmentId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.authorizeCreateProgram(user, departmentId);
        });
    }
    authorizeDeleteProgram(user, departmentId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.authorizeCreateProgram(user, departmentId);
        });
    }
};
DepartmentProgramAuthorization = __decorate([
    (0, inversify_1.injectable)()
], DepartmentProgramAuthorization);
exports.default = DepartmentProgramAuthorization;
