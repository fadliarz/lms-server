...
exports.CreateUserDtoJoi = joi_1.default.object({
    ...
    medicalHistories: joi_1.default.string().required(),
    HMM: joi_1.default.string().required(),
    UKM: joi_1.default.string().required(),
    hobbies: joi_1.default.string().required(),
...
exports.UpdateBasicUserDtoJoi = joi_1.default.object({
    ...
    medicalHistories: joi_1.default.string(),
    HMM: joi_1.default.string(),
    UKM: joi_1.default.string(),
    hobbies: joi_1.default.string(),
